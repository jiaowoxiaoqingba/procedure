...
require_once("/application/publicpart/controller/lib/alipay_core.function.php");
require_once("/application/publicpart/controller/lib/alipay_md5.function.php");
class AlipaysubmitController extends Controller{
