...
class TaskController extends BaseController{
    ...
    public function taskorders(){
        ...
        $mediafield = "m.nick as mnick,w.follower as mfollower";
        $fansnum = 0;
        $moneytotal = 0;
        foreach($orderList as &$v){
           $mediaid = $v['payeeid'];
           $media_info = $this->mediaProcess->getMediainfo($mediaid,$mediafield);
